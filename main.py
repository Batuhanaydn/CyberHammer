...
#     #   #   #    # #      #   #  #     # #    # #    # #    # #      #   #  
 #####    #   #####  ###### #    # #     # #    # #    # #    # ###### #    # """)
    ...
    print("Usage: main.py -t target_host -p port")
...
def main():
    ...
    for o,a in opts:
        ...
        if not listen and len(target) and port > 0:
            ...
            # read in the buffer from th commandline
            # this will bloack, sp send CTRL-D if not sending input
            # to stdin
...
def server_loop():
    global target
    # İf no target is defined, we listen on all interfaces
    if not len(target):
        target = "0.0.0.0"
    ...
    if len(upload_destination):
        ...
        while True:
            ...
            if not data:
                ...
                file_buffer += data
        try:
            file_descriptor = open(upload_destination, "wh")
